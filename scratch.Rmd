...
```{r}
##Save things in yaml when needed
source('R/make_organic_carbon_fraction.R')
#write_yaml(make_bulk_density(), file = 'data_model/bulk_density.yml')
cat(as.yaml(make_organic_carbon_fraction()))
```
...
```{r}
##Save things in yaml when needed
source('R/make_data_source.R')
#write_yaml(make_data_source(), file = 'data_model/data_source.yml')
cat(as.yaml(make_data_source()))
```
